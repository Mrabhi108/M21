...
TOKEN = '7375833210:AAGrPbR_u6j9Q5Q3bUSPdaPlcQjp_5AcFsY'
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Help selected @tencenttfather*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin selected @tencenttfather*", parse_mode='Markdown')
    else:
